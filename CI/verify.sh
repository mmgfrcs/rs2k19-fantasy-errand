...
cd ./Assets/
files=(Imports/ Materials/ Models/ Sprites/ Scripts/ Scenes/ StreamingAssets/ Prefabs/ Animations/ Audio/ Textures/ Profiles/ Models/ Resources/ Presets/ Fonts/ Packages/)
for f in $(ls -d */); do
    found=0
    for g in "${files[@]}" ; do
        [ "$f" = "$g" ] && found=1
